...
public class DetailItemExpired extends BaseLayout implements DetailImageLoaderInterface {
	/**
	 * Data source.
	 */
...
//	private AnimationDrawable loadingAnimation;
	 ...
	 */
	public DetailItemExpired(BaseLayoutActivity baseLayoutActivity) {
	...
	protected int getXMLToInflate() { 
		return R.layout.lay_dsc_detail_item_expired;
	} 
...
//		ivLoading = (ImageView) view.findViewById(R.id.ivLoading);
	...
	protected void initValues() {
		...
		tvInfo.setText(view.getResources().getString(R.string.DSC_DETAIL_DISCOUNT_EXPIRED));
